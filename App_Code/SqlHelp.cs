...
public class SqlHelp
{
    ///私有属性:数据库连接字符串
        ...
        private const string connectionString = "Data Source=(Local);Pooling=False;Max Pool Size = 1024;Initial Catalog=Library;Persist Security Info=True;User ID=sa;Password=123456";
